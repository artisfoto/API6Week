...
//import com.inicio.dao.Conexion;
...
public class Interfaz extends JFrame {
    ...
    public Interfaz(){
        ...
        //Se crea el botón y también se define el comportamiento que tendrá, en este caso invocaremos el método Verificación
        JButton ingresar = new JButton("Ingresar");
        ingresar.setBounds(100, 150, 150, 25);
